...
void Cell::setNeighbours() {
	...
	case (W - 1) : //Right side
		if (index == W - 1) { //Top right front			(2) 
			...
			else if (y != 0 && y != H && z != 0 && z != L){ //Right side (23)
		...
		break;
	default:
		if (x > 0 && x < W && y > 0 && y < H && z > 0 && z < L){ //(21) //Centralt
		...
		else if (y == 0 && x > 0 && x < W && z > 0 && z < L){ //(29) Bottenplatta
		...
		else if (z == 0 && x > 0 && x < W && y > 0 && y < H){	//(5) Bortaplatta
		...
		else if (z == L && x > 0 && x < W && y > 0 && y < H){ //(53) //Motplattan
			...
			//cout << index + W + 1<< endl;
			//cout << index + W*H << endl; 
			//cout << index + W*H - 1 << endl;
			//cout << index + W*H + 1 << endl;
			//cout << index + W*H - W << endl;
			//cout << index + W*H - W - 1 << endl;
			//cout << index + W*H - W + 1 << endl;
