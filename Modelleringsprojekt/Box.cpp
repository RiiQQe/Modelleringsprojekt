...
void Box::DrawBox()
{
	...
	for (int i = 1; i < GRID_HEIGHT; i++) {
		glVertex2f((512.f/GRID_HEIGHT) * i, 0);    //Line on the Y - axis
		glVertex2f((512.f / GRID_HEIGHT) * i, 512); //Line on the Y - Axis

		glVertex2f(0, (512.f / GRID_WIDTH) * i); //Line on X - axis
		glVertex2f(512, (512.f / GRID_WIDTH) * i);
	}
/*
